...
# revalidation decides whether a CI repair may ship without review, and
# decision_checks declares which guards the fix agent may never touch.
ci:
  rerun_transient: 0
